...
function isAlmostSame(num1, num2) {
  ...
  if (num1 - num2 < Number.EPSILON && num2 - num1 < Number.EPSILON) return true;
  else return false;
}
...
function isSafeInteger(num) {
  // Перевіряємо, чи є число меншим або рівним MAX_SAFE_INTEGER і більшим або рівним MIX_SAFE_INTEGER
